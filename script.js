const localStoregeKey = 'to-do-list-ld'

function validateIfExistsNewTask(){
    let values = JSON.parse(localStorage.getItem(localStoregeKey) || '[]')
...
function newTask(){
    ...
    if (!input.value){
        ...
        localStorage.setItem(localStoregeKey,JSON.stringify(values))
        showValues()
    }
    input.value = ''
